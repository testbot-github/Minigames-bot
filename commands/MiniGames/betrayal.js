const {
  ...
  module.exports = {
    name: "betrayal.io",
    category: "MiniGames",
    aliases: ["Betrayal.io", "betrayal.io", "Betrayal", "betrayal"],
    description: "Generate a link to play Betrayal.io (through discord)",
    usage: "Betrayal.io, Click on the button!",
    ...
    run: async (client, message, args, cmduser, text, prefix, es) => {
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            .then(invite => {
                if (!invite.code) {
                  ...
                  .setDescription(`Cannot start the Betrayal.io, please retry`)
                  .setColor(ee.wrongcolor)
      ...
      const join = new MessageButton().setStyle(`url`).setEmoji("👿").setLabel(`Play Betrayal.io`).setURL(`https://discord.com/invite/${invite.code}`)
