const {
  ...
  module.exports = {
    ...
    category: "MiniGames",
    aliases: ["chess", "Chess"],
    description: "Generate a link to play Chess (through discord)",
    usage: "Chess, Click on the button!",
    ...
    run: async (client, message, args, cmduser, text, prefix, es) => {
      ...
      const join = new MessageButton().setStyle(`url`).setEmoji("♟️").setLabel(`Play Chess`).setURL(`https://discord.com/invite/${invite.code}`)
