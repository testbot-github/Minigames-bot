const {
  ...
  module.exports = {
    name: "chessdev",
    category: "MiniGames",
    aliases: ["chessdev", "Chessdev"],
    description: "Generate a link to play Chess dev (through discord)",
    usage: "Chess Dev, Click on the button!",
    ...
    run: async (client, message, args, cmduser, text, prefix, es) => {
      try {
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            body: JSON.stringify({
                max_age: 86400,
                max_uses: 0,
                target_application_id: "832012586023256104", // Chessdev
                target_type: 2,
                temporary: false,
                validate: null
            }),
            ...
            .then(invite => {
                if (!invite.code) {
                  ...
                  .setDescription(`Cannot start the Chess Dev, please retry`)
                  .setColor(ee.wrongcolor)
      ...
      const join = new MessageButton().setStyle(`url`).setEmoji("♟️").setLabel(`Play Chess Dev`).setURL(`https://discord.com/invite/${invite.code}`)
