const {
  ...
  module.exports = {
    name: "lettertile",
    category: "MiniGames",
    aliases: ["Lettertile", "LetterTile"],
    description: "Generate a link to play lettertile (through discord)",
    usage: "lettertile, Click on the button!",
    ...
    run: async (client, message, args, cmduser, text, prefix, es) => {
      try {
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            body: JSON.stringify({
                max_age: 86400,
                max_uses: 0,
                target_application_id: "879863686565621790", // lettertile
                target_type: 2,
                temporary: false,
                validate: null
            }),
            ...
            .then(invite => {
                if (!invite.code) {
                  ...
                  .setDescription(`Cannot start the Lettertile, please retry`)
                  .setColor(ee.wrongcolor)
      ...
      const join = new MessageButton().setStyle(`url`).setEmoji("🐟").setLabel(`Play Lettertile`).setURL(`https://discord.com/invite/${invite.code}`)
