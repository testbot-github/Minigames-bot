const {
  ...
  module.exports = {
    ...
    description: "Generate a link to play poker (through discord)",
    usage: "pokernight, Click on the button!",
    ...
    run: async (client, message, args, cmduser, text, prefix, es) => {
      try {
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            body: JSON.stringify({
                max_age: 86400,
                max_uses: 0,
                target_application_id: "755827207812677713", // pokernight
                target_type: 2,
                temporary: false,
                validate: null
            }),
            ...
            .then(invite => {
                if (!invite.code) {
                  ...
                  .setDescription(`Cannot start the pokernight, please retry`)
                  .setColor(ee.wrongcolor)
      ...
      const join = new MessageButton().setStyle(`url`).setEmoji("🌃").setLabel(`Play Poker Night`).setURL(`https://discord.com/invite/${invite.code}`)
