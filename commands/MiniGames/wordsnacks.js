const {
  ...
  module.exports = {
    name: "wordsnacks",
    category: "MiniGames",
    aliases: ["Wordsnacks", "WordSnacks"],
    description: "Generate a link to play wordsnacks (through discord)",
    usage: "wordsnacks, Click on the button!",
    ...
    run: async (client, message, args, cmduser, text, prefix, es) => {
      try {
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            body: JSON.stringify({
                max_age: 86400,
                max_uses: 0,
                target_application_id: "879863976006127627", // wordsnacks
                target_type: 2,
                temporary: false,
                validate: null
            }),
            ...
            .then(invite => {
                if (!invite.code) {
                  ...
                  .setDescription(`Cannot start the wordsnacks, please retry`)
                  .setColor(ee.wrongcolor)
      ...
      const join = new MessageButton().setStyle(`url`).setEmoji("🆕").setLabel(`Play Wordsnacks`).setURL(`https://discord.com/invite/${invite.code}`)
