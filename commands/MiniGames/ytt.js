const {
  ...
  module.exports = {
    ...
    usage: "youtubetogether, Click on the button!",
    ...
    run: async (client, message, args, cmduser, text, prefix, es) => {
      try {
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            body: JSON.stringify({
                max_age: 86400,
                max_uses: 0,
                target_application_id: "755600276941176913", // youtubetogether
                target_type: 2,
                temporary: false,
                validate: null
            }),
      ...
      const ytjoin = new MessageButton().setStyle(`url`).setEmoji("865965667370795028").setLabel(`Watch YouTube`).setURL(`https://discord.com/invite/${invite.code}`)
